...
# Database
POSTGRES_DATABASE=postgresql://postgres:password@localhost:5432/outlai
...
MAILTRAP_PORT=2525
MAILTRAP_USER=seu-usuario-mailtrap
MAILTRAP_PASS=sua-senha-mailtrap
...
Se preferir executar localmente sem Docker, você precisará ter PostgreSQL e Redis instalados e rodando em sua máquina.

1. Configure as URLs de conexão no `.env` de acordo com suas instalações locais
...
Se você tiver alguma dúvida ou problema, por favor abra uma [issue](https://github.com/paulohcardoson/outlai-app-backend/issues).
